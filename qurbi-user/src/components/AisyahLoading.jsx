...
export function AisyahCardSkeleton({ count = 6, variant = "grid" }) {
  if (variant === "list") {
    return (
...
export function AisyahPageLoader({ label = "Loading…" }) {
  return (
    <div className="aisyah-page flex min-h-screen items-center justify-center px-5">
