...
import { DataSource, DeepPartial, EntityManager, Like, Repository } from 'typeorm';
import {
  BulkListing,
  CartItem,
...
export class OrdersService {
  ...
  async markReceived(id: string, proofImages: string[], userId?: string): Promise<Order> {
  ...
  async reviewRefund(
    ...
    order.refundStatus = input.approve ? RefundStatus.APPROVED : RefundStatus.REJECTED;
